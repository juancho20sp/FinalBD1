...
//Registrar el id del producto a editar
...
//Añadir precio de venta
    if(isset($_POST['precio'])){
        ...
        $stmt -> execute(array(
            ':price' => $_POST['precio'],
            ':id' => $_SESSION['codigoProducto']
        ));

        unset($_SESSION['codigoProducto']); 
...
<body class="super-container">
                                        ...
                                        <form method="post">
                                          <div class="row">
                                              <div class="form-group row">
                                                  ...
                                                  <input name="codigo" type="number" class="form-control col-10" id="codigo" placeholder="Ingrese el código">
                                              </div>                                                              
                                          </div>                                                           
                                          <button type="submit" class="btn btn-primary ml-1"><a data-toggle="modal" data-target="#priceModal" data-dismiss="modal">Editar</a></button>
    ...
    <!--Acaba del modal-->
    <!--Empieza el modal de inserción de precio-->
        ...
        <table class="table table-striped">
            ...
            <?php                            
                ...
                while($row = $stmt->fetch(PDO::FETCH_ASSOC)){
                    ...
                    echo ('</a>'); 
                    echo ("\n</form>\n");  
                    $_SESSION['elemento'] = $row['idProducto'];
                }       
            ?>
            </tbody>
        </table>
